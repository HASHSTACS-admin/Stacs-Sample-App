 ...
 */
@Slf4j
@Component("smtt-abs-subscription-payment-1-v1" + SUFFIX_CALLBACK)
public class AbsPaymentCallbackHandler implements SmtCallbackHandler {
    ...
    public void handle(DrsSmtMessage message) {
        ...
        if (message.success()) {
            ...
            tradeBidOrder.setBizStatus(StatusEnum.BidBizStatus.PAYMENT.getCode());
        } else {
